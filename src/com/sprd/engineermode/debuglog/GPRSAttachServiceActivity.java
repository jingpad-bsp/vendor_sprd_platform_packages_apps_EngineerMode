...
public class GPRSAttachServiceActivity extends PreferenceActivity implements
    ...
    private static final String PROP_ATTACH_ENABLE = "persist.vendor.sys.attach.enable";
...
//        final SubscriptionManager subscriptionManager = SubscriptionManager.from(this);
        mSetSim= SubscriptionManagerProxy.getDefaultDataPhoneId();
            ...
            switch (msg.what) {
                ...
                case SET_GPRSDETACH:
                   // mSetSim = (int) msg.arg1;
                    SystemPropertiesProxy.set(PROP_ATTACH_ENABLE, "false");
                ...
                case SET_GPRSATTACH:
                   // mSetSim = (int) msg.arg1;
                        SystemPropertiesProxy.set(PROP_ATTACH_ENABLE, "true");
                    serverName = "atchannel" + mSetSim;
