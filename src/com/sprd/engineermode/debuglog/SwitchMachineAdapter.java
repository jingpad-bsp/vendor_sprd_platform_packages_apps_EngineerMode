...
public class SwitchMachineAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(tempModeArray != null && tempModeArray.size() > position) bootMode = tempModeArray.get(position);
        if(tempTimeArray != null && tempTimeArray.size() > position) bootTime = tempTimeArray.get(position);
        String bootMsg = String.format(Locale.US, "position = %d, time = %s, mode = %s", position, bootTime, bootMode);
        Log.d(TAG, bootMsg);
        ...
        switch (mMode) {
            case SwitchBaseActivity.MODE_POWER_ON: {
                ...
                if ( bootMode == null ) {
                    modeId = R.string.normal_poweron;
            ...
            case SwitchBaseActivity.MODE_POWER_OFF: {
                ...
                if ( bootMode == null ) {
                    modeId = R.string.normal_poweroff;
