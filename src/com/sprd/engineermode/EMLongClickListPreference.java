...
public class EMLongClickListPreference extends ListPreference implements OnClickListener, OnLongClickListener {

    final static String TAG = "EMLongClickListPreference";
     ...
     * @param defStyle
     */
    public EMLongClickListPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init();
    }

    public EMLongClickListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
