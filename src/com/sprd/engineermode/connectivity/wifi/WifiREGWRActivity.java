...
import com.unisoc.engineermode.core.intf.IConnectivityApi.IWifiEut.WifiREG;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case DEINIT_TEST_STATUS:
                    if (!WifiEUTHelper.getHelper().removeMod()) {
                    ...
                    break;
                case WIFI_REG_READ:
                    analysisResult(WifiEUTHelper.getHelper().regr(mWifiReg));
                    break;
                case WIFI_REG_WRITE:
                    analysisResult(WifiEUTHelper.getHelper().regw(mWifiReg));
                    break;
                default:
                    break;
            }
