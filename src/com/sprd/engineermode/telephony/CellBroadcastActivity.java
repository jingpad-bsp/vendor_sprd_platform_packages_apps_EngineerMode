...
public class CellBroadcastActivity extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCellBroadcast = new EMSwitchPreference[TelephonyManagerProxy.getPhoneCount()];

		for (int i = 0; i < TelephonyManagerProxy.getPhoneCount(); i++) {
			...
			TelephonyManager telMgr = (TelephonyManager) TelephonyManagerProxy.getService();
