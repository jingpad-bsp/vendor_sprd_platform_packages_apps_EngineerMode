...
public class LockC2KFreqActivity extends Activity {
    private static final String TAG = "LockC2KFreqActivity";
    ...
    private Handler mUiThread = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case SETLOCKFRQ: {
                String atRsult = (String) msg.obj;
                if (atRsult.contains(IATUtils.AT_OK)) {
                    Toast.makeText(LockC2KFreqActivity.this, "Lock Success",
            ...
            case SETUNLOCKFRQ: {
                String atRsult = (String) msg.obj;
                if (atRsult.contains(IATUtils.AT_OK)) {
                    Toast.makeText(LockC2KFreqActivity.this, "Unlock Success",
                            Toast.LENGTH_SHORT).show();
        ...
        public void handleMessage(Message msg) {
            ...
            case GETLOCKFRQ: {
                String atResponse = IATUtils.sendATCmd(
                        engconstents.ENG_AT_GET_SPC2KFRQ, "atchannel0");
                ...
                if (!isSupportLTE) {
                    for (int line = 0; line < DEFAULT_LOCK_MAX; line++) {
                        atResponse = IATUtils.sendATCmd(
                                engconstents.ENG_AT_SET_SPC2KFRQ
                                        + "0,"
                                        + line
                                        + ","
            ...
            case SETUNLOCKFRQ: {
                ...
                for (int i = 0; i < DEFAULT_LOCK_MAX; i++) {
                    atResponse = IATUtils.sendATCmd(
                            engconstents.ENG_AT_SET_SPC2KFRQ + "1", "atchannel0");
                    if (!atResponse.contains(IATUtils.AT_OK)) {
                        mUiThread.sendMessage(mUiThread.obtainMessage(
        ...
        if (isSupportLTE) {
            if (mFreqEdit[0].getText().toString().trim() != null
                ...
                if (freq0 < 0 || freq0 > 65535) {
                    Toast.makeText(LockC2KFreqActivity.this, "Para is wrong",
                            Toast.LENGTH_SHORT).show();
                    return mFreqEdit[0];
                }
    ...
    class LockFreqATFailRunnable implements Runnable {
        ...
        @Override
        public void run() {
            Toast.makeText(LockC2KFreqActivity.this, "Fail", Toast.LENGTH_SHORT)
                    .show();
        }
    ...
    class LockFreqATSuccessRunnable implements Runnable {
        ...
        @Override
        public void run() {
            Toast.makeText(LockC2KFreqActivity.this, "Success", Toast.LENGTH_SHORT)
                    .show();
        }
